...
<div class="navbar navbar-inverse navbar-static-top">
    <div class="container">
        <a href="login.php" class="navbar-brand">F1 Predictor 2017</a>
            ...
            <div class = "panel panel-default">
                <div class = "panel-body">
                    ...
                    <ol>
                        ...
                        <li>Driver and Constructor prices will be recalculated after each race, based on their performance over a rolling 12 month period. For example, once the Australian G.P. is complete each Driver's and Team's price for the next race will be re-calculated on the Total 2015 season points scored minus the 2016 Australian GP plus the 2017 Australian GP points, and so on after each race.</li>
